...
|-----|------|-------------|
| 🥁 **Metronome** | `metronome.html` | BPM control (40–240), tap tempo, time-signature selector, visual pendulum & beat flash. Keyboard: `Space` start/stop, `T` tap, `↑/↓` adjust BPM. |
| 🎺 **Brass Tuner** | `tuner.html` | Microphone pitch detector using autocorrelation. Shows note name, frequency, cents deviation and a needle meter. Optimised for the range of brass instruments (tuba → trumpet). |
